...
public class ImageController : Controller
{
    ...
    public async Task<IActionResult> UploadRoomImage(int roomId, IFormFile imageFile)
    {
        ...
        try
        {
            ...
            TempData["Success"] = "Obrázek byl úspěšně nahrán.";
        ...
        catch (Exception ex)
        {
            ...
            TempData["Error"] = "Chyba při nahrávání obrázku.";
        }
    ...
    public IActionResult GetRoomImage(int roomId)
    {
        try
        {
            ...
            {
                // DŮLEŽITÉ: vrátit redirect na SVG
