...
CREATE OR REPLACE VIEW ROOM_REQUEST_V ( name, email, location, min_capacity, reservation_start, reservation_end, reservation_length, id_room_request, vc_ready, podium_size ) AS
SELECT
    organizers.name,
    organizers.email,
...
FROM
    ...
    INNER JOIN presentation_rrequests ON room_requests.id_room_request = presentation_rrequests.id_room_request
    INNER JOIN meeting_rrequests ON room_requests.id_room_request = meeting_rrequests.id_room_request
;

CREATE OR REPLACE VIEW ROOM_V ( name, capacity, location, availabilitystart, availabilityend, vc_ready, podium_size ) AS
SELECT
    rooms.name,
    rooms.capacity,
    locations.name AS "location",
...
CREATE OR REPLACE VIEW USERS_V ( ID_ORGANIZER, email, credential_type, data, created_at, name ) AS
SELECT
    o.ID_ORGANIZER,
    o.email,
    c.credential_type,
