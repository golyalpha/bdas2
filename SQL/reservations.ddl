...
CREATE TABLE cities (
    ...
    countries_id_country NUMBER NOT NULL
);
...
ALTER TABLE cities ADD CONSTRAINT cities_name_country_id_country_un UNIQUE ( name,
...
CREATE TABLE credentials (
    ...
    organizers_id_organizer NUMBER NOT NULL
);
...
CREATE TABLE images (
    ...
    data                    BLOB NOT NULL,
    organizers_id_organizer NUMBER NOT NULL,
    locations_id_location   NUMBER NOT NULL,
...
ALTER TABLE images ADD CONSTRAINT image_pk PRIMARY KEY ( id_image );
...
CREATE TABLE locations (
    ...
    cities_id_city          NUMBER NOT NULL,
    organizers_id_organizer NUMBER NOT NULL
);

ALTER TABLE locations ADD CONSTRAINT locations_pk PRIMARY KEY ( id_location );

ALTER TABLE locations ADD CONSTRAINT locations_name_city_id_city_un UNIQUE ( name,
                                                                             cities_id_city );
...
ALTER TABLE cities
    ADD CONSTRAINT cities_countries_fk FOREIGN KEY ( countries_id_country )
        REFERENCES countries ( id_country );

ALTER TABLE credentials
    ADD CONSTRAINT credentials_organizers_fk FOREIGN KEY ( organizers_id_organizer )
        REFERENCES organizers ( id_organizer );

ALTER TABLE images
    ADD CONSTRAINT image_locations_fk FOREIGN KEY ( locations_id_location )
        REFERENCES locations ( id_location );

ALTER TABLE images
    ADD CONSTRAINT image_organizers_fk FOREIGN KEY ( organizers_id_organizer )
        REFERENCES organizers ( id_organizer );

ALTER TABLE images
    ADD CONSTRAINT image_room_fk FOREIGN KEY ( room_id_room )
        REFERENCES rooms ( id_room );

ALTER TABLE locations
    ADD CONSTRAINT locations_cities_fk FOREIGN KEY ( cities_id_city )
        REFERENCES cities ( id_city );

ALTER TABLE locations
    ADD CONSTRAINT locations_organizers_fk FOREIGN KEY ( organizers_id_organizer )
        REFERENCES organizers ( id_organizer );
...
ALTER TABLE notifications
    ADD CONSTRAINT notifications_organizers_fk FOREIGN KEY ( organizers_id_organizer )
        REFERENCES organizers ( id_organizer );

ALTER TABLE organizers
    ADD CONSTRAINT organizers_roles_fk FOREIGN KEY ( roles_id_role )
...
ALTER TABLE reservations
    ADD CONSTRAINT reservations_organizers_fk FOREIGN KEY ( organizers_id_organizer )
        REFERENCES organizers ( id_organizer );
...
CREATE OR REPLACE VIEW ROOM_REQUEST_V ( name, email, location, min_capacity, reservation_start, reservation_end, reservation_length, vc_ready, podium_size ) AS
SELECT
    organizers.name,
    organizers.email,
...
FROM
         room_requests
    INNER JOIN locations ON location.id_location = room_requests.id_location
    INNER JOIN organizers ON organizer.id_organizer = room_requests.id_organizer,
    meeting_rrequests,
    presentation_rrequests 
;

CREATE OR REPLACE VIEW ROOM_V ( name, capacity, location, availability_start, availability_end, vc_ready, podium_size ) AS
SELECT
    rooms.name,
    rooms.capacity,
    locations.name AS "location",
