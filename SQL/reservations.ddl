...
DROP VIEW COUNTRYIES_V CASCADE CONSTRAINTS 
;
...
CREATE OR REPLACE VIEW COUNTRYIES_V ( ID_COUNTRY
   , name )
 AS SELECT
    ID_COUNTRY
   , name
...
CREATE OR REPLACE VIEW ROOMS_V ( name, capacity, location, availability_start, availability_end, vc_ready, podium_size ) AS
SELECT
    rooms.name,
    rooms.capacity,
